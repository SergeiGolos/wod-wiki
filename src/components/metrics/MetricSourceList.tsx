/**
 * MetricSourceList.tsx - List component for IMetricSource visualization
 *
...
export interface MetricSourceListProps {
    ...
    onClick?: (source: IMetricSource) => void;
...
export const MetricSourceList: React.FC<MetricSourceListProps> = ({
    entries,
    size = 'normal',
    filter,
    activeItemId,
    ...
    // Handlers
    const handleClick = useCallback((source?: IMetricSource, modifiers?: { ctrlKey: boolean; shiftKey: boolean }) => {
    ...
    const handleDoubleClick = useCallback((source?: IMetricSource) => {
        if (source) onDoubleClick?.(source);
    }, [onDoubleClick]);

    const handleHover = useCallback((source?: IMetricSource | null | undefined) => {
        onHover?.(source as IMetricSource | null);
    }, [onHover]);
        ...
        return (
            ...
            >
                <MetricSourceRow
                    ...
                    duration={duration}
                    metricGroups={entry.metricGroups}
