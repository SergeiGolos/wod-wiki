    ...
    <Headless.Listbox {...props} multiple={false}>
      <Headless.ListboxButton
        ...
        className={cn([
          ...
          // Disabled state
          'data-[disabled]:opacity-50 data-[disabled]:before:bg-muted/50 data-[disabled]:before:shadow-none',
        ])}
      >
        <Headless.ListboxSelectedOption
          ...
          className={cn([
            ...
            // Border
            'border border-border/60 group-data-[active]:border-border group-data-[hover]:border-border dark:border-white/10 dark:group-data-[active]:border-white/20 dark:group-data-[hover]:border-white/20',
            // Background color
            'bg-transparent dark:bg-white/5',
            // Invalid state
            'group-data-invalid:border-destructive group-data-[hover]:group-data-invalid:border-destructive dark:group-data-invalid:border-destructive dark:data-[hover]:group-data-invalid:border-destructive',
            // Disabled state
            'group-data-[disabled]:border-border/40 group-data-[disabled]:opacity-100 dark:group-data-[disabled]:border-white/15 dark:group-data-[disabled]:bg-white/2.5 dark:group-data-[disabled]:data-[hover]:border-white/15',
          ])}
        />
