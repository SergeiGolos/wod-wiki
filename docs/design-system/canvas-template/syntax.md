...
Inherits all standard Canvas layout behaviour from [Canvas Page](design-system/canvas-template/_template.md#layout-system-integration). No structural overrides on this route.
