...
7. **Substitution proof:** summary substitution validates retained coverage descriptors and reducer statistics against the requested operation — a capability proof, never a population recompute — keeping the per-summary hot-path cost bounded for ticket 20's budgets ([contribution-selection deepening](../deepening/01-contribution-selection.md)).
