...
|---------|--------|-------------|----------|
| **Timer** | `:SS`, `MM:SS`, `HH:MM:SS` | Time duration | `:30`, `2:00`, `1:30:00` |
| **Repetitions** | Plain numbers | Count of repetitions | `10`, `21`, `100` |
| **Exercise** | Text labels | Exercise description | `Push-ups`, `Box Jumps`, `Run` |
| **Weight** | Number + unit | Resistance amount | `95lb`, `40kg`, `50%` |
| **Distance** | Number + unit | Distance measure | `400m`, `5km`, `1mile` |
| **Rounds** | `(n)`, `(n-n-n)` | Round scheme | `(5)`, `(21-15-9)` |
| **Group Start** | `-` prefix | Start new group | `- 10 Push-ups` |
| **Group Continue** | `+` prefix | Continue group | `+ 10 Sit-ups` |
...
This creates a 30-second countdown timer.
...
This creates an exercise with 10 repetitions.
