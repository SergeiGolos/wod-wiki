...
## IMPORTANT: Codebase Intelligence Instructions for wod-wiki
...
| timespan | 93 |  |
| components/review-grid | 73 |  |
| external:@ | 57 |  |
| components/external:@ | 45 |  |
### Hotspots (High Churn)
| File | Churn | 90d Commits | Owner |
|------|-------|-------------|-------|
| `playground/src/App.tsx` | 99.9th %ile | 86 | Serge Golos |
| `playground/src/canvas/MarkdownCanvasPage.tsx` | 99.8th %ile | 32 | Serge Golos |
| `src/components/Editor/extensions/widget-block-preview.tsx` | 99.8th %ile | 13 | Serge |
| `playground/src/pages/EffortDetailPage.tsx` | 99.7th %ile | 7 | Serge |
| `playground/src/views/queriable-list/JournalDateScroll.tsx` | 99.6th %ile | 18 | Serge Golos |

## Code health
Hotspot health: 6.62/10 (stable) ·
Average: 7.42/10 ·
Worst: 1.0/10 (`src/runtime/ScriptRuntime.ts`)

### Critical biomarkers
- `playground/src/canvas/MarkdownCanvasPage.test.tsx` — churn risk — impact −2.4
- `playground/src/components/HomeHero.tsx` — churn risk — impact −2.4
- `playground/src/pages/PlaygroundLandingPage.tsx` — churn risk — impact −2.4
- `src/views/runtime/metricColorMap.ts` — churn risk — impact −2.4
- `stories/catalog/organisms/FullscreenReview.stories.tsx` — churn risk — impact −2.4
