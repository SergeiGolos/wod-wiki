...
export const CONSTRUCT_REGISTRY: ConstructItem[] = [
  {
    ...
    gridRoute: '/guide/syntax/cheatsheet#amrap',
  },
  {
    id: 'emom',
    label: 'EMOM',
    ...
    route: '/guide/behaviors/timers',
    sublabel: 'Timer behaviors',
    gridRoute: '/guide/syntax/cheatsheet#emom',
  },
  {
    id: 'tabata',
    label: 'Tabata',
    ...
    route: '/guide/behaviors/timers',
    sublabel: 'Timer behaviors',
    gridRoute: '/guide/syntax/cheatsheet#tabata',
  },
  {
    id: 'rest',
    label: 'Rest',
    ...
    route: '/guide/behaviors/timers',
    sublabel: 'Timer behaviors',
    gridRoute: '/guide/syntax/cheatsheet#rest',
  },
  {
    id: 'duration',
    label: 'Duration',
  ...
  },
  {
    ...
    gridRoute: '/guide/syntax/cheatsheet#ladders',
  },
  {
    id: 'rounds',
    label: 'Rounds',
    terms: ['rounds'],
    route: '/guide/syntax/cheatsheet#rounds',
    sublabel: 'Cheat sheet',
    gridRoute: '/guide/syntax/cheatsheet#rounds',
  },
  {
    id: 'supersets',
    label: 'Supersets',
    terms: ['supersets'],
    route: '/guide/syntax/cheatsheet#supersets',
    sublabel: 'Cheat sheet',
    gridRoute: '/guide/syntax/cheatsheet#supersets',
  },
  {
    id: 'actual',
    label: 'Actual result',
    ...
    gridRoute: '/guide/syntax/cheatsheet#actual',
  },
  {
    id: 'load-prompt',
    label: 'Load prompt',
    ...
    route: '/guide/behaviors/capture',
    sublabel: 'Capture & feedback',
    gridRoute: '/guide/syntax/cheatsheet#load-prompt',
  },
  {
    id: 'metrics',
    label: 'Metrics',
    terms: ['metrics', 'reps', 'effort', 'discipline'],
    route: '/guide/syntax/cheatsheet#metrics',
    sublabel: 'Cheat sheet',
    gridRoute: '/guide/syntax/cheatsheet#metrics',
  },
  {
    id: 'palette',
