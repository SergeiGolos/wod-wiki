...
import { LoadJournalZipPage } from './pages/LoadJournalZipPage'
            ...
            <CommandProvider>
              <NavProvider tree={navTree}>
                <Routes>
                  ...
                  <Route path={ROUTE_PATTERNS.loadJournal} element={<Suspense fallback={<div className="flex-1 flex items-center justify-center text-zinc-400">Loading…</div>}><LoadJournalZipPage /></Suspense>} />
                  <Route path={ROUTE_PATTERNS.loadJournalDate} element={<Suspense fallback={<div className="flex-1 flex items-center justify-center text-zinc-400">Loading…</div>}><LoadJournalZipPage /></Suspense>} />
