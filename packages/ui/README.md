...
- **CodeMirror Extensions**: Complete set of CodeMirror 6 extensions (`@bitcobblers/wod-wiki-ui/extensions`) for autocomplete, linting, block previews, syntax hiding, theme, line IDs, and navigation.
...
```bash
bun add @bitcobblers/wod-wiki-ui @bitcobblers/wod-wiki-engine
```
