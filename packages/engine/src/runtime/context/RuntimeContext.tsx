 ...
 * use RuntimeLifecycleProvider from '../../contexts/RuntimeLifecycleProvider' instead.
 * 
...
export function useScriptRuntimeOptional(): IScriptRuntime | undefined {
  return useContext(ScriptRuntimeContext);
}
