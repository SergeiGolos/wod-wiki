...
function globEffortModules(): Record<string, string> {
  try {
    ...
    // The two patterns cover both import sites: from this package's
    // repositories dir (repo root markdown) and from a sibling layout.
    return (import.meta as any).glob(
      ['../../../../markdown/efforts/**/*.md', '../../markdown/efforts/**/*.md'],
      {
        query: '?raw',
        eager: true,
        import: 'default',
