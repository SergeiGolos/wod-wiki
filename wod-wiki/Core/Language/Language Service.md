Main entry point for parsing workout script text into executable runtime structures. Orchestrates the lexer, parser, and visitor to transform raw text into `WodRuntimeScript` objects.
